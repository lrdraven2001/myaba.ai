...
const TERMS: Section[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      '“Customer Content” means the data, documents, and materials the Customer or its Authorized Users submit to the Service, excluding PHI (which is governed by the BAA).',
      '“Output” means material the Service generates from Customer Content.',
      '“PHI” means Protected Health Information as defined under HIPAA and is governed by the BAA.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'A claim does not become uncapped merely because it is asserted as an indemnification obligation; an indemnification claim is subject to the tier applicable to the underlying conduct. Claims arising from the same or substantially related events are treated as a single claim, and these limits apply collectively (not cumulatively) across these Terms, all Orders, the DPA, and the BAA.',
