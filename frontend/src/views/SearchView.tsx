        ...
        <div>
          ...
          <div className="relative flex items-center">
            ...
            <input
              ...
              className="w-full pl-10 pr-10 py-3 border-2 border-gray-200 rounded-xl text-sm focus:outline-hidden focus:border-teal-500 transition-colors bg-white"
            />
            {query && (
              <button
                onClick={handleClear}
...
export function HitCard({ hit, onClick }: { hit: SearchHit; onClick: () => void }) {
  ...
  return (
    <button
      onClick={onClick}
      className="w-full text-left bg-white border border-gray-200 rounded-xl px-4 py-3 hover:border-teal-300 hover:shadow-xs transition-all group"
    >
