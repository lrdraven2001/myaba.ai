          ...
          {activeTab === 'upload' && (
            <div>
              <input
                ref={fileInputRef}
                type="file"
                accept=".pdf,.docx,.xlsx,.xls,.txt,.md,.csv,.png,.jpg,.jpeg,.webp,.gif"
                multiple
                style={{ display: 'none' }}
              ...
              >
                ...
                <p className="text-xs text-gray-400 mt-1">PDF, Word, Excel, CSV, text, images/screenshots — max 20 MB each, up to {MAX_ATTACHMENTS} files</p>
                <button
                  type="button"
